          ...
          <motion.div style={{ opacity: scrollYProgress }}>
            <ContactSectionText>
              <Text type="heading2" color="grey4">
                ...
                três formas pra gente se falar!
              </Text>
            </ContactSectionText>
          </motion.div>
          <ContactsCards>
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Podemos marcar uma chamada de voz ou conversar por mensagem, vamos?
                </Text>
                <Text
                  as="a"
                  color="grey2"
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Quer passar algum feedback ou tem alguma sugestão? me mande um email :)
                </Text>
                <Text
                  as="a"
                  color="grey2"
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Vamos nos conectar e fazer network?
                </Text>
                <Text
                  as="a"
                  color="grey2"
